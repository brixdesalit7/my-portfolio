    ...
    <div className='footer-content'>
        ...
        <div className='footer-icons'>
            <ul>
                ...
                <li><a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJZXhxtRXTMNNcNWVhMrGbnlWhmZKZjJlBVlChjFJBtzPCShDTjcRfBXtLWQcplZRbkpbFg" target="_blank"><i className="bi bi-google"></i></a></li>
